...
public class KayttajaKl extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int kayttajaid, lankanro;
        String nimi;
        int paluukoodi = 0;
        
        kayttajaid = Integer.parseInt(jTextField6.getText());
        nimi = jTextField7.getText();
        
        Kayttaja kayttaja = new Kayttaja();
        RistipistoTyo tyo = new RistipistoTyo();
        RistipistoTyoKokoelma ristipistoTyoKokoelma = new RistipistoTyoKokoelma();
        LankaKokoelma lankaKokoelma = new LankaKokoelma();
        
        // Lisätään ristipistotyö kokoelmaan
        tyo.korkeus = Integer.parseInt(jTextField2.getText());
        tyo.leveys = Integer.parseInt(jTextField3.getText());
        tyo.tyoId = Integer.parseInt(jTextField1.getText());
        
        // Lisätään langat työ -kokoelmaan
        
        lankaKokoelma.setOmatLangat(null);
        
//        ristipistoTyoKokoelma.setRistipistoTyot(null);
